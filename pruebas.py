...
# class Pruebas(unittest.TestCase): # Este NO guarda pero no muestra suficiente informacion
#     db = conectar_db()
#
#     @patch('main.comprobar_token', return_value=True)
#     def test_comprobar_token(self, comprobar_token):
#         self.assertTrue(comprobar_token(db, "12345QWERTY"))
#
#     @patch('main.comprobar_token', return_value=False)
#     def test_comprobar_token_false(self, comprobar_token):
#         self.assertFalse(comprobar_token(db, "123"))
#
#     @patch('main.guardar_voto', return_value=None)
#     def test_guardar_voto(self, guardar_voto):
#         self.assertIsNone(guardar_voto(db, "8", "1", "6", "3"))
#
#     @patch('main.guardar_voto', return_value=None) # No pilla bien el error
#     def test_guardar_voto_false(self, guardar_voto):
#         self.assertIsNotNone(guardar_voto(db, "1", "1", "1", "1"))
#         # self.assertRaises(guardar_voto(db, "1", "1", "1", "1"), _mysql_exceptions.IntegrityError)
#         # self.assertIsInstance(guardar_voto(db, "1", "1", "1", "1"), _mysql_exceptions.IntegrityError)
#
#
# def test_comprobar_token():
#     """
#     >>> comprobar_token(conectar_db(), "12345QWERTY")
#     True
#     >>> comprobar_token(conectar_db(), "123")
#     False
#     """
#
#
# def test_guardar_voto():
#     """
#     >>> guardar_voto(conectar_db(),"8", "1", "6", "3")
#     """
#     # >>> guardar_voto(conectar_db(),"1", "1", "1", "1")
#     # Traceback (most recent call last):
#     #   File "/usr/lib/python2.7/doctest.py", line 1315, in __run
#     #     compileflags, 1) in test.globs
#     #   File "<doctest __main__.test_guardar_voto[1]>", line 1, in <module>
#     #     guardar_voto(conectar_db(),"1", "1", "1", "1")
#     #   File "/home/vidriosoft/Escritorio/EGC-Almacenamiento-G2/database.py", line 98, in guardar_voto
#     #     cursor.execute(add_vote, data_vote1)
#     #   File "/usr/lib/python2.7/dist-packages/MySQLdb/cursors.py", line 226, in execute
#     #     self.errorhandler(self, exc, value)
#     #   File "/usr/lib/python2.7/dist-packages/MySQLdb/connections.py", line 36, in defaulterrorhandler
#     #     raise errorvalue
#     # IntegrityError: (1062, "Duplicate entry '1-1-1' for key 'token_usuario, token_votacion, token_pregunta'")
