...
#Esta parte de pruebas hay que eliminarla en la version final
key = 'Almacen de votos'
test=pad('A ver esto que tal funciona')
print(test)
s=encrypt('A ver esto que tal funciona')
